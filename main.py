...
def attack(char_name: str, char_class: str) -> str:
    """Выполняет атаку в соответствии с классом персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет защиту в соответствии с классом персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Использует умение в соответствии с классом персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Проводит обучение в соответствии с классом персонажа."""
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack — чтобы'
          'атаковать противника, defence — чтобы блокировать атаку'
          'противника или special —'
